            ...
            <div className="sect1-p" data-aos="fade-down">
                <div id="about-me-bio">
                    ...
                    <p id="bio-paragraph">
                        ...
                        Whether its making My websites responsive with animations or searching for color schemes to really grasp the users attention. When I think of frontend I think of the user and what will keep their eyes gravitated toward the screen. 
                        Born in Richmond Virginia and growing along with the city while seeing many things being built around me, I picked up the trait of being innovative and thinking of solutions to solving world problems but software engineering wasn't where I took my innovative thought just yet. My first innovative project was when I was 11 years of age. 
                        sketching out the architecture of a bike that hops when I click a button. I didn't realize it at first but what I was doing was doing before even attempting to build the bike was in essence psuedo coding or in other words creating my plan of action. what would make this bike jump, where would this piece of technology be on the bike, and will this of course be fun. I was always a drawer, bringing my imagination about through a number two pencil and a peice of paper. 
                        I then decided in 2017 to take my art digital and learned the skill of graphic design at the age of 18. I improved on this skill and was able to make it a side gig in which I created logos for clients. I then longed for going further into this rapidly changing digital world and decided I wanted to be a programmer and I have to say I am very happy with my decision because I developed a passion for solving problems and designing impactful web and mobile applications. Its very interesting how one skill can lead into another don't you think?
